    ...
    Promise
      ...
      .then((xhrs) => {
        ...
        resolve({
          ...
          videopujcovna: homescreen.result[1].result,
          doporucujeme: homescreen.result[2].result,
          porady: homescreen.result[3].result,
          primaFilmy: homescreen.result[4].result,
          primaVareni: homescreen.result[5].result,
